...
**Añadido 2026-08-27, decisión de Felipe (CT-18.7 de la spec):** la etapa siguiente también
incluye un **censo completo de tokens** — barrer toda la app (todos los módulos, pestañas,
secciones, modales, formularios y objetos granulares) buscando todo lo que necesite un token
definido, no solo color. Task 8 de ESTA etapa sigue acotada al tema claro de la hoja de Intermedia
únicamente; el censo completo entra a la re-priorización de F3–F5 de Task 9, dimensionado con el
número del piloto.
