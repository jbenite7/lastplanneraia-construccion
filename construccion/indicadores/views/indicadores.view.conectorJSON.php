...
<body>
	...
	<div class="encabezado" id="encabezado">
		<input type="hidden" name="seccion" id="seccion" value="indicadores">
	...
	<script>
		...
		var listar = function(seccion) {
			...
			if (seccion == 'informeProgramacionSemanal') {
				var url = 'https://datastudio.google.com/embed/reporting/d09cc023-c284-4379-b77e-9c15d0ed6909/page/p_hmejfblomc' + '?params=%7B"df49":"include%25EE%2580%25800%25EE%2580%2580IN%25EE%2580%2580' + proyecto + '",';

				if(semana > 6){
					url = url + '"df48":"include%25EE%2580%25801%25EE%2580%2580BT%25EE%2580%2580'+ (semana-5) + '%25EE%2580%2580'+ semana + '"%7D';
				}
				else{
					url = url + '"df48":"include%25EE%2580%25801%25EE%2580%2580' + 'LTE%25EE%2580%2580'+ (semana) + '"%7D';
				}
			}else if (seccion == 'informeProgramacionIntermedia') {
				var url = 'https://datastudio.google.com/embed/reporting/d09cc023-c284-4379-b77e-9c15d0ed6909/page/p_v8jvkiw2rc' + '?params=%7B"df79":"include%25EE%2580%25800%25EE%2580%2580IN%25EE%2580%2580' + proyecto + '",';

				url = url + '"df65":"include%25EE%2580%25801%25EE%2580%2580IN%25EE%2580%2580'+ semana +'"%7D';
			}else if (seccion == 'informeProgramaGeneral') {
				var url = 'https://datastudio.google.com/embed/reporting/d09cc023-c284-4379-b77e-9c15d0ed6909/page/p_4yvejh07oc' + '?params=%7B"df54":"include%25EE%2580%25800%25EE%2580%2580IN%25EE%2580%2580' + proyecto + '"%7D';
			}else if (seccion == 'informePDC') {
				var url = 'https://datastudio.google.com/embed/reporting/d09cc023-c284-4379-b77e-9c15d0ed6909/page/p_fpogvgqtuc' + '?params=%7B"df90":"include%25EE%2580%25800%25EE%2580%2580IN%25EE%2580%2580' + proyecto + '",';

				url = url + '"df91":"include%25EE%2580%25801%25EE%2580%2580IN%25EE%2580%2580'+ semana +'",';

				if(semana > 6){
					url = url + '"df92":"include%25EE%2580%25801%25EE%2580%2580BT%25EE%2580%2580'+ (semana-5) + '%25EE%2580%2580'+ semana + '",';
				}
				else{
					url = url + '"df92":"include%25EE%2580%25801%25EE%2580%2580' + 'LTE%25EE%2580%2580'+ (semana) + '",';
				}

				if(semana > 1){
					url = url + '"df93":"include%25EE%2580%25801%25EE%2580%2580IN%25EE%2580%2580'+ (semana - 1) +'",';
				}else{
					url = url + '"df93":"include%25EE%2580%25801%25EE%2580%2580IN%25EE%2580%2580'+ (0) +'",';
				}

				url = url + '"df94":"include%25EE%2580%25801%25EE%2580%2580IN%25EE%2580%2580'+ semana +'"%7D';
			}else if (seccion == 'informeProveedores') {
				var url = 'https://datastudio.google.com/embed/reporting/d09cc023-c284-4379-b77e-9c15d0ed6909/page/p_23433wqtuc' + '?params=%7B"df173":"include%25EE%2580%25800%25EE%2580%2580IN%25EE%2580%2580' + proyecto + '"%7D';
			}

			var informe = '<iframe width="100%" height="100%" src=\''+ url +'\' frameborder="0" style="border:0" allowfullscreen></iframe>';

			var filaBotones = '<button id="btn_informeProgramaGeneral" type="button" class="btn btn-outline-secondary btn-sm" onclick="listar(\'informeProgramaGeneral\')">Programa General</button><button id="btn_informeProgramacionIntermedia" type="button" class="btn btn-outline-secondary btn-sm" onclick="listar(\'informeProgramacionIntermedia\')">Liberación de Restricciones</button><button id="btn_informeProgramacionSemanal" type="button" class="btn btn-outline-secondary btn-sm" onclick="listar(\'informeProgramacionSemanal\')">Programación Semanal</button><button id="btn_informePDC" type="button" class="btn btn-outline-secondary btn-sm" onclick="listar(\'informePDC\')">Plan de Compras</button><button id="btn_informeProveedores" type="button" class="btn btn-outline-secondary btn-sm" onclick="listar(\'informeProveedores\')">Calificación de Subcontratistas</button>';


			document.getElementById('contenedorInformeDataStudio').innerHTML = informe;
			document.getElementById('contenedorInformeDataStudio').style.height = (alturahoja - posicionInicioInforme - 15) + "px";
