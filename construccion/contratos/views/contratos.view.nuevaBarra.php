...
<body>
	...
	<div class="encabezado" id="encabezado">
		<input type="hidden" name="seccion" id="seccion" value="info_contratos">
							...
							<div id="cuadro4" class="cuadro4 col-sm-12 col-md-12 col-lg-12 ">
								<form class="form form-horizontal" action="" method="POST">
									...
									<div class="form-group parametro_EditarContratos" id="parametro_EditarContratosS">
										...
										<div class="col-sm-12">
											<br>
											<label for="S1" class="control-label" style='width:1000px; max-width:17% ; padding:1px; margin:0; display:inline-block; text-align:center'></label>
											<label for="paqueteS1" class="control-label" style='width:1000px; max-width:41% ; padding:1px; margin:0; display:inline-block; text-align:center'><h5>Paquete de Contratación</h5></label>
											<label for="S1" class="control-label" style='width:1000px; max-width:41% ; padding:1px; margin:0; display:inline-block; text-align:center'><h5>Insumo / Recurso</h5></label>

											<label for="paqueteS1" class="control-label" style="width:1000px; max-width:17% ;display:inline-block; text-align:center"><h5>1.</h5></label>
											<select id="paqueteS1" name="paqueteS1" type="text" class="form-control" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>
											<select id="S1" name="S1[]" type="text" class="form-control" multiple="multiple" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>

											<label for="paqueteS2" class="control-label" style="width:1000px; max-width:17% ;display:inline-block; text-align:center"><h5>2.</h5></label>
											<select id="paqueteS2" name="paqueteS2" type="text" class="form-control" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>
											<select id="S2" name="S2[]" type="text" class="form-control" multiple="multiple" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>

											<label for="paqueteS3" class="control-label" style="width:1000px; max-width:17% ;display:inline-block; text-align:center"><h5>3.</h5></label>
											<select id="paqueteS3" name="paqueteS3" type="text" class="form-control" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>
											<select id="S3" name="S3[]" type="text" class="form-control" multiple="multiple" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>

											<label for="paqueteS4" class="control-label" style="width:1000px; max-width:17% ;display:inline-block; text-align:center"><h5>4.</h5></label>
											<select id="paqueteS4" name="paqueteS4" type="text" class="form-control" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>
											<select id="S4" name="S4[]" type="text" class="form-control" multiple="multiple" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>

											<label for="paqueteS5" class="control-label" style="width:1000px; max-width:17% ;display:inline-block; text-align:center"><h5>5.</h5></label>
											<select id="paqueteS5" name="paqueteS5" type="text" class="form-control" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>
											<select id="S5" name="S5[]" type="text" class="form-control" multiple="multiple" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>
										</div>
										<br>
									...
									<div class="form-group parametro_EditarContratos" id="parametro_EditarContratosMO">
										...
										<div class="col-sm-12">
											<br>
											<label for="MO1" class="control-label" style='width:1000px; max-width:17% ; padding:1px; margin:0; display:inline-block; text-align:center'></label>
											<label for="paqueteMO1" class="control-label" style='width:1000px; max-width:41% ; padding:1px; margin:0; display:inline-block; text-align:center'><h5>Paquete de Contratación</h5></label>
											<label for="MO1" class="control-label" style='width:1000px; max-width:41% ; padding:1px; margin:0; display:inline-block; text-align:center'><h5>Insumo / Recurso</h5></label>

											<label for="paqueteMO1" class="control-label" style="width:1000px; max-width:17% ;display:inline-block; text-align:center"><h5>1.</h5></label>
											<select id="paqueteMO1" name="paqueteMO1" type="text" class="form-control" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>
											<select id="MO1" name="MO1[]" type="text" class="form-control" multiple="multiple" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>

											<label for="paqueteMO2" class="control-label" style="width:1000px; max-width:17% ;display:inline-block; text-align:center"><h5>2.</h5></label>
											<select id="paqueteMO2" name="paqueteMO2" type="text" class="form-control" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>
											<select id="MO2" name="MO2[]" type="text" class="form-control" multiple="multiple" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>

											<label for="paqueteMO3" class="control-label" style="width:1000px; max-width:17% ;display:inline-block; text-align:center"><h5>3.</h5></label>
											<select id="paqueteMO3" name="paqueteMO3" type="text" class="form-control" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>
											<select id="MO3" name="MO3[]" type="text" class="form-control" multiple="multiple" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>

											<label for="paqueteMO4" class="control-label" style="width:1000px; max-width:17% ;display:inline-block; text-align:center"><h5>4.</h5></label>
											<select id="paqueteMO4" name="paqueteMO4" type="text" class="form-control" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>
											<select id="MO4" name="MO4[]" type="text" class="form-control" multiple="multiple" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>

											<label for="paqueteMO5" class="control-label" style="width:1000px; max-width:17% ;display:inline-block; text-align:center"><h5>5.</h5></label>
											<select id="paqueteMO5" name="paqueteMO5" type="text" class="form-control" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>
											<select id="MO5" name="MO5[]" type="text" class="form-control" multiple="multiple" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>
										</div>
										<br>
									...
									<div class="form-group parametro_EditarContratos" id="parametro_EditarContratosSI">
										...
										<div class="col-sm-12">
											<br>
											<label for="SI1" class="control-label" style='width:1000px; max-width:17% ; padding:1px; margin:0; display:inline-block; text-align:center'></label>
											<label for="paqueteSI1" class="control-label" style='width:1000px; max-width:41% ; padding:1px; margin:0; display:inline-block; text-align:center'><h5>Paquete de Contratación</h5></label>
											<label for="SI1" class="control-label" style='width:1000px; max-width:41% ; padding:1px; margin:0; display:inline-block; text-align:center'><h5>Insumo / Recurso</h5></label>

											<label for="paqueteSI1" class="control-label" style="width:1000px; max-width:17% ;display:inline-block; text-align:center"><h5>1.</h5></label>
											<select id="paqueteSI1" name="paqueteSI1" type="text" class="form-control" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>
											<select id="SI1" name="SI1[]" type="text" class="form-control" multiple="multiple" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>

											<label for="paqueteSI2" class="control-label" style="width:1000px; max-width:17% ;display:inline-block; text-align:center"><h5>2.</h5></label>
											<select id="paqueteSI2" name="paqueteSI2" type="text" class="form-control" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>
											<select id="SI2" name="SI2[]" type="text" class="form-control" multiple="multiple" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>

											<label for="paqueteSI3" class="control-label" style="width:1000px; max-width:17% ;display:inline-block; text-align:center"><h5>3.</h5></label>
											<select id="paqueteSI3" name="paqueteSI3" type="text" class="form-control" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>
											<select id="SI3" name="SI3[]" type="text" class="form-control" multiple="multiple" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>

											<label for="paqueteSI4" class="control-label" style="width:1000px; max-width:17% ;display:inline-block; text-align:center"><h5>4.</h5></label>
											<select id="paqueteSI4" name="paqueteSI4" type="text" class="form-control" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>
											<select id="SI4" name="SI4[]" type="text" class="form-control" multiple="multiple" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>

											<label for="paqueteSI5" class="control-label" style="width:1000px; max-width:17% ;display:inline-block; text-align:center"><h5>5.</h5></label>
											<select id="paqueteSI5" name="paqueteSI5" type="text" class="form-control" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>
											<select id="SI5" name="SI5[]" type="text" class="form-control" multiple="multiple" style='width:41%; max-width:41%; padding:1px; margin:0; display:inline-block; border-color:rgb(206, 212, 218, 0)'>
												<option value=""></option>
											</select>
										</div>
										<br>
									...
									<div class="form-group">
										<div class="col-sm-12">
											<input id="btn_guardar_contratos" type="button" class="btn btn-primary" value="Guardar">
											<input id="btn_cancelar_contratos" type="button" class="btn btn-danger" value="Cancelar" data-dismiss="modal">
										</div>
									</div>
								</form>
							</div>
      ...
      listar();
		...
		var listar = function() {
		  ...
		  var alturahoja = $(window).height();
			...
			var alturatabla = (alturahoja - posicionInicioTabla - 150) + "px";
		  ...
		  var table = $("#dt_cliente").DataTable({
		    ...
		    "ajax": {
		      "method": "POST",
		      "url": "../contratos/listar_contratos.php?db="+db+"&semana="+Max_Semana
		    },
			...
			$("div.toolbarFilaBotones").html('<div class="grupo_botones1" role="group" aria-label="Basic example" style="padding:5; max-width:50%;display:inline-block; "><button id="btn_tutorialActualizarCronograma" type="button" class="btn btn-secondary btn-sm" style="margin-right:5px" title="Video tutorial de la sección de \'\'Paquetes de Contratación\'\'" onclick="window.open(\'https://youtu.be/7zNHgNC7O_8\', \'_blank\')">Tutorial <i class="fas fa-list-ol fa-lg"></i></button></div><div class="grupo_botones_semanal_madre"  style="padding:5; max-width:69%"><div class="grupo_botones_semanal btn-group" role="group" aria-label="Basic example"><button id="btn_Actividades" type="button" class="btn btn-success btn-sm" onclick="window.location.href=\'../cambiar_pagina.php?seccion=info_listadoActividades&semana='+semana+'\'">Actividades <i class="fas fa-arrow-right fa-m"></i></button><button id="btn_contratos" type="button" class="btn btn-success btn-sm active" onclick="window.location.href=\'../cambiar_pagina.php?seccion=info_contratos&semana='+semana+'\'">Contratos <i class="fas fa-arrow-right fa-m"></i></button><!-- <button id="btn_paquetesContratacion" type="button" class="btn btn-success btn-sm" onclick="window.location.href=\'../cambiar_pagina.php?seccion=info_paquetesContratacion&semana='+semana+'\'">Paquetes de Contratación <i class="fas fa-arrow-right fa-m"></i></button> --><button id="btn_planCompras" type="button" class="btn btn-success btn-sm" onclick="window.location.href=\'../cambiar_pagina.php?seccion=planCompras&semana='+semana+'\'">Plan de Compras</button></div></div>');
		...
		var obtener_data_editar = function(tbody, table) {
		  ...
		  $(tbody).one("click", "td", function(e) {
		    ...
		    if (only_once == true) {
					...
					$.ajax({
						method: "POST",
						url: "../contratos/guardar_contratos.php?db="+db,
						...
						$.ajax({
							...
							if(tipoContrato==1){
								...
								var MO1 = data.MO1!='' ? $("#MO1").val(data.MO1.split(';')).change() : '';
								var MO2 = data.MO2!='' ? $("#MO2").val(data.MO2.split(';')).change() : '';
								var MO3 = data.MO3!='' ? $("#MO3").val(data.MO3.split(';')).change() : '';
								var MO4 = data.MO4!='' ? $("#MO4").val(data.MO4.split(';')).change() : '';
								var MO5 = data.MO5!='' ? $("#MO5").val(data.MO5.split(';')).change() : '';
								...
								var S1 = data.S1!='' ? $("#S1").val(data.S1.split(';')).change() : '';
								var S2 = data.S2!='' ? $("#S2").val(data.S2.split(';')).change() : '';
								var S3 = data.S3!='' ? $("#S3").val(data.S3.split(';')).change() : '';
								var S4 = data.S4!='' ? $("#S4").val(data.S4.split(';')).change() : '';
								var S5 = data.S5!='' ? $("#S5").val(data.S5.split(';')).change() : '';
								...
								var SI1 = data.SI1!='' ? $("#SI1").val(data.SI1.split(';')).change() : '';
								var SI2 = data.SI2!='' ? $("#SI2").val(data.SI2.split(';')).change() : '';
								var SI3 = data.SI3!='' ? $("#SI3").val(data.SI3.split(';')).change() : '';
								var SI4 = data.SI4!='' ? $("#SI4").val(data.SI4.split(';')).change() : '';
								var SI5 = data.SI5!='' ? $("#SI5").val(data.SI5.split(';')).change() : '';
