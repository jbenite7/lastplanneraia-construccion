		...
		<div class="header-actions action-bar" style="margin-bottom: 8px;">
			<div class="pg-actions-row">
				<div class="d-flex flex-wrap align-items-center" style="gap:6px;">
					...
					<button id="btn_toggleFiltroMapeo" type="button" class="btn-pdc-modern active" title="Alternar visualización de actividades" aria-label="Alternar visualización">Mostrando Pendientes <i class="fas fa-filter fa-lg"></i></button>
