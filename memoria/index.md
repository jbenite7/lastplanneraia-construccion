...
Decisiones, conceptos, trampas, referencias, módulos y flujos, generados desde el frontmatter de
cada página (`tipo`, `resumen`, `areas`, `fecha`). La base trae las seis vistas seleccionables — no
hace falta un embebido por tabla.
