...
| `--ds-*` | 363 | El **alias semántico**: para qué sirve cada color en una interfaz. Eran 295 el 2026-08-24; el tema claro contractual (2026-08-28) trajo el resto. Medido con `grep -cE '^\s*--ds-[a-zA-Z0-9-]+:' public/css/tokens.css` el 2026-09-03. |
