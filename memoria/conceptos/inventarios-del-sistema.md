...
|---|---|---|
| `vendors.json` | **homologación con candado** | Librerías de terceros: versión, entrega, `adapterMaturity`, y el `sha256` de cada asset local — `scripts/design-system-contracts.mjs:868-893` verifica que los archivos existan y no hayan sido alterados |
