...
export const esquemaFilaActividadPg = z.object({
  ...
  Estado_Restricciones: z.union([z.string(), z.number()]).transform(String).nullable().optional(),
  cantidad_ppto: z.coerce.number().nullable().optional(),
  unidad: z.string().nullable().optional(),
  codigo_actividad: z.union([z.string(), z.number()]).transform(String).nullable().optional(),
