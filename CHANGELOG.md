...
>
> Esta funcionalidad se construyó sobre el commit desplegado en producción y **no existe en `main`**:
> un deploy futuro desde `main` la retiraría. Replicarla es trabajo pendiente, anotado en [[TASKS]].
