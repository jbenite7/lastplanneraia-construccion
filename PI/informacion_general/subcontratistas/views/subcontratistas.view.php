            ...
            <nav class="navbar navbar-expand-m navbar-dark ">
              <a class="navbar-brand" href="#">
                <ul>
                    ...
                    <li class="lps">LPS</li>
                    <li class="pagina"> - Información General / Terceros</li>
                </ul>
              </a>
                ...
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu show" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item active" href="<?php echo"../../cambiar_pagina.php?seccion=info_subcontratistas&semana=$semana"?>">Terceros</a>
                    </div>
                  </li>
		...
		<div id="cuadro2" class="col-sm-12 col-md-12 col-lg-12 ">
			<form class="form form-horizontal" action="" method="POST">
				<div class="form-group">
					...
					Formulario de Registro de Nuevos Sub-Contratistas</h3>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-8"><input id="Subcontratista" name="Subcontratista" type="text" class="form-control" ></div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="alcance" class="col-sm-4 control-label">Alcance</label>
					<div class="col-sm-8"><input id="alcance" name="alcance" type="text" class="form-control" ></div>
                </div>
				<!--<div class="form-group">
					<label for="tipo_proveedor" class="col-sm-4 control-label">Tipo de Proveedor</label>
                    <div class="col-sm-8"><select id="tipo_proveedor" name="tipo_proveedor" class="form-control" >
			...
			<form class="form-botones" action="" method="POST">
				...
				<div class="form-group">
					<div class="col-sm-offset-1 col-sm-8">
						<input id="btn_nuevo" type="button" class="btn btn-primary btn-sm" title="Registrar nuevo Sub-Contratista en el proyecto" value="Registrar Sub-Contratista">
					</div>
				</div>
			</form>
	...
	<script>
		...
		var guardar = function(){
			$("form").on("submit", function(e){
				...
				$.ajax({
					method: "POST",
					url: "../subcontratistas/guardar_subcontratistas.php?db=<?php echo $db?>",
...
//                "responsive":true,
                ...
                "ajax":{
                  "method":"POST",
                  "url":"../subcontratistas/listar_subcontratistas.php?db=<?php echo $db?>"
              },
        ...
        var obtener_data_editar=function(tbody, table){
            $(tbody).on("click", "button.editar", function(){
                ...
                var Id=$("#Id").val(data.Id),
                    Id1=$("#Id1").val(data.Id),
                    Subcontratista=$("#Subcontratista").val(data.Subcontratista),
                    Correo=$("#Correo").val(data.Correo),
                    NIT=$("#NIT").val(data.NIT),   
                    alcance=$("#alcance").val(data.alcance),
                    //tipo_proveedor=$("#tipo_proveedor").val(data.tipo_proveedor),
