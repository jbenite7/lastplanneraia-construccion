<?php
	...
	$query="SELECT COUNT(*) FROM $db"."_programa_consolidado WHERE Semana=$semana AND Titulo=0 AND Dias_Inicio<=Lookahead AND Categoria = 'consultores' $script";
    ...
    if ($conteo==0){
        ...
        require ("../conexion.php");
        $query1 = "SELECT * FROM $db"."_programa_consolidado WHERE Semana=$semana AND Titulo=0 AND Dias_Inicio<=Lookahead AND Categoria = 'consultores' $script";
