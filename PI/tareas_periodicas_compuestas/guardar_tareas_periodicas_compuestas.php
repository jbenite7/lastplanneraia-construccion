...
function generar_checklist($db, $Id, $checklist, $semana, $conexion){
    ...
    $cadena ="<div class='form_eval form-group'>
               ...
               <!--<div class='pregunta form-group' style='margin:auto; margin-top:10px'>
                    <p style='display:inline-block'>¿La repetición de esta tarea se encuentra activa? (Sí/No):   </p>
                    <select name='activa' id='activa' style='width:100%; max-width:100px; height:30px; font-size:1em; text-align: center; padding-left:1px; padding-right:0px; margin:0px 2px; border-radius: 5px; border-style:solid; border-color:darkgrey'>
               ...
               <div class='pregunta form-group' style='margin:auto; margin-top:10px'>
                    ...
                    <select name='ejecutado' id='ejecutado' style='width:100%; max-width:200px; height:30px; font-size:1em; text-align: center; padding-left:1px; padding-right:0px; margin:0px 2px; border-radius: 5px; border-style:solid; border-color:darkgrey'>
                      ...
                      <option value=0.75>Periodicidad Activa</option>
                      <option value=1>Terminado</option>
                    </select>
               </div>
               <div class='pregunta form-group' style='margin:auto; margin-top:10px'>
                    <p style='display:inline-block'>Indique la relevancia de la tarea (1 - 10):   </p>
                    <select name='relevancia' id='relevancia' style='width:100%; max-width:140px; height:30px; font-size:1em; text-align: center; padding-left:1px; padding-right:0px; margin:0px 2px; border-radius: 5px; border-style:solid; border-color:darkgrey'>
               ...
               <div class='pregunta form-group' style='margin:auto; margin-top:10px'>
                    <p style='display:inline-block'>Indique la periodicidad de la tarea (días):   </p>
                    <input type='text' name='periodicidad' id='periodicidad' style='width:100%; max-width:135px; height:30px; font-size:1em; text-align: center; padding-left:1px; padding-right:0px; margin:0px 2px; border-radius: 5px; border-style:solid; border-color:darkgrey'></input>
               </div>
                 ";
...
function modificar_checklist($Id, $semana, $relevancia, $ejecutado, $periodicidad, $f_inicio_sem, $R1, $R2, $R3, $R4, $R5, $R6, $R7, $R8, $R9, $R10, $R11, $R12, $R13, $R14, $R15, $R16, $R17, $R18, $R19, $R20, $R21, $R22, $R23, $R24, $R25, $checklist, $url_R1, $url_R2, $url_R3, $url_R4, $url_R5, $url_R6, $url_R7, $url_R8, $url_R9, $url_R10, $url_R11, $url_R12, $url_R13, $url_R14, $url_R15, $url_R16, $url_R17, $url_R18, $url_R19, $url_R20, $url_R21, $url_R22, $url_R23, $url_R24, $url_R25, $Observaciones, $db, $conexion){
    $suma=0;
    $conteo=0;
...
function comprometer_requerimiento($consecutivo, $semana, $checklist, $requerimiento, $consecutivo_requerimiento, $db, $conexion){
    ...
    if($conteo>0){ 
        ...
        $query2="INSERT INTO $db"."_programacion_semanal (Consecutivo, Semana, Consecutivo_en_Programa, Id, Actividad, Descripcion, Clase, Critica, Atrasada, Activa, Prog_Sin_Restricciones_100) VALUES (NULL, $semana, $consecutivo, '$Id (R$consecutivo_requerimiento)', '$requerimiento', 'Requerimiento de la actividad: $Actividad', 'Checklist TPC', $Ruta_Critica, $Atrasada, 'NA', 0)";
        $resultado2= mysqli_query($conexion, $query2);
    }
    cerrar($conexion);
}
