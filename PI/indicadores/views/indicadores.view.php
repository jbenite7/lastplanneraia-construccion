...
<header class="header">
    <div class="encabezado">
        <ul>
            ...
            ?>
            <li><h1 class="titulo" style="background:white">Last Planner Proyectos Inmobiliarios AIA - <?php echo "$proyecto, Semana $semana " ?><h2 class="titulo_pequeño"><?php echo"(del $Fecha_Inicio_SemYMD al $Fecha_Fin_SemYMD)"?></h2></h1></li>
        </ul>
    </div>
...
<main class="main">
				...
				<div class="form-group">
					<div class="col-sm-offset-1 ">
                        <div class="grupo_botones btn-group" role="group" aria-label="Basic example" style="padding:10">
                            ...
                            <button id="btn_Actividades" type="button" class="btn btn-success btn-sm " onclick="window.location.href='<?php echo "../cambiar_pagina.php?seccion=programacion_semanal&semana=$semana"?>'">Actividades <i class="fas fa-arrow-right fa-m"></i></button>
                            <button id="btn_CNP" type="button" class="btn btn-success btn-sm" onclick="window.location.href='<?php echo "../cambiar_pagina.php?seccion=evaluacion_semanal&semana=$semana"?>'">Evaluación Semanal <i class="fas fa-arrow-right fa-m"></i></button>
	...
	<div class="row">
        <div id="div_grafico_PAC" style="width: 95%; max-width: 1300px; margin:auto; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px; padding: 2px 2px 10px 2px">
            <form class="form form-horizontal" action="" method="POST">
                <div class="form_eval form-group">
                    ...
                    <div class="grupo_clase_PAC" style="width:600px; max-width:33%; display: inline-block;">
                        <label for="clase_PAC" class="col-sm-8 control-label">General / Profesional / Terceros</label>
                        <div class="col-sm-9"><select id="clase_PAC" name="clase_PAC" class="form-control" onchange="cambio_clase_PAC()">
                            ...
                            <option value="subcontratista">Tercero</option>
                        </select>
                        </div>	
                    </div>
        ...
        <div id="div_Pareto_CNC" style="width: 95%; margin:auto; max-width: 1300px; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px; padding: 2px 2px 10px 2px">
            <form class="form form-horizontal" action="" method="POST">
                <div class="form_eval form-group">
        ...
        <div id="div_Semana_CNC" style="width: 95%; margin:auto; max-width: 1300px; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px; padding: 2px 2px 10px 2px">
            <form class="form form-horizontal" action="" method="POST">
                <div class="form_eval form-group">
                    <h3 id="form_adm_Semana_CNC">Acumulado Semanal de Causas de No Cumplimiento</h3>
                </div>
        ...
        <div id="div_ind_compromisos" style="width: 95%; margin:auto; max-width: 1300px; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px; padding: 2px 2px 10px 2px">
            <form class="form form-horizontal" action="" method="POST">
                <div class="form_eval form-group">
        ...
        <div id="div_restricciones" style="width: 95%; margin:auto; max-width: 1300px; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px; padding: 2px 2px 10px 2px">
            <form class="form form-horizontal" action="" method="POST">
                <div class="form_eval form-group">
            ...
            <div id="contenedor_graficos_restricciones" class="contenedor_graficos_restricciones">
                ...
                <div id="combo_restricciones_1" style="width: 100%; height: 143px; margin-left:3%; margin-right:2%; text-align: center">
                    <div id="semana_combo_restricciones_1" style="width: 13%; height: 140px; text-align: center; vertical-align: middle; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:white; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    <?php 
                        require("../conexion.php");
                    ...
                    <div id="restricciones_1" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#1D3330; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                ...
                <div id="combo_restricciones_2" style="width: 100%; height: 143px; margin-left:3%; margin-right:2%; text-align: center">
                    <div id="semana_combo_restricciones_2" style="width: 13%; height: 140px; text-align: center; vertical-align: middle; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:white; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    <?php 
                        require("../conexion.php");
                    ...
                    <div id="restricciones_2" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#325955; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                    <div id="restricciones_3" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#1D3330; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                ...
                <div id="combo_restricciones_3" style="width: 100%; height: 143px; margin-left:3%; margin-right:2%; text-align: center">
                    <div id="semana_combo_restricciones_3" style="width: 13%; height: 140px; text-align: center; vertical-align: middle; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:white; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    <?php 
                        require("../conexion.php");
                    ...
                    <div id="restricciones_4" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#478079; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                    <div id="restricciones_5" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#325955; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                    <div id="restricciones_6" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#1D3330; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                ...
                <div id="combo_restricciones_4" style="width: 100%; height: 143px; margin-left:3%; margin-right:2%; text-align: center">
                    <div id="semana_combo_restricciones_4" style="width: 13%; height: 140px; text-align: center; vertical-align: middle; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:white; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    <?php 
                        require("../conexion.php");
                    ...
                    <div id="restricciones_7" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#5DA69D; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                    <div id="restricciones_8" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#478079; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                    <div id="restricciones_9" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#325955; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                    <div id="restricciones_10" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#1D3330; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                ...
                <div id="combo_restricciones_5" style="width: 100%; height: 143px; margin-left:3%; margin-right:2%; text-align: center">
                    <div id="semana_combo_restricciones_5" style="width: 13%; height: 140px; text-align: center; vertical-align: middle; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:white; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    <?php 
                        require("../conexion.php");
                    ...
                    <div id="restricciones_11" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#72CCC2; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                    <div id="restricciones_12" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#5DA69D; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                    <div id="restricciones_13" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#478079; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                    <div id="restricciones_14" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#325955; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                    <div id="restricciones_15" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#1D3330; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                ...
                <div id="combo_restricciones_6" style="width: 100%; height: 143px; margin-left:3%; margin-right:2%; text-align: center">
                    <div id="semana_combo_restricciones_6" style="width: 13%; height: 140px; text-align: center; vertical-align: middle; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:white; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    <?php 
                        require("../conexion.php");
                    ...
                    <div id="restricciones_16" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#88F2E6; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                    <div id="restricciones_17" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#72CCC2; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                    <div id="restricciones_18" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#5DA69D; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                    <div id="restricciones_19" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#478079; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                    <div id="restricciones_20" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#325955; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                    <div id="restricciones_21" style="width: 13%; height: 140px; text-align: center; display: inline-block; float:left; margin-left: 0.1%; margin-right:0.1%; background:#1D3330; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px;" >
                    </div>
                </div>
        ...
        <div id="div_calificaciones_integrales" style="width: 95%; margin:auto; max-width: 1300px; border-style: solid; border-width: 2px; border-color: rgba(55,86,54,1); border-radius: 5px; padding: 2px 2px 10px 2px">
            <form class="form form-horizontal" action="" method="POST">
                <div class="form_eval form-group">
            ...
            <div id="calificacion_contratistas" style="width: 100%; height: 400px; margin-top: 60px; text-align: center" >
            </div>
            <div id="calificacion_profesionales" style="width: 100%; height: 400px; margin-top: 60px; text-align: center" >
            </div>
        </div>
...
<!--    <script type='text/javascript'>document.oncontextmenu = function(){return false}</script>-->
    ...
    $(document).on("ready", function(){
        ocultos();
        $('#div_Pareto_CNC').css('display', 'none');
        $('#div_Semana_CNC').css('display', 'none');
        ...
        var jsonData = $.ajax({
          ...
          function drawVisualization() {
            ...
            var options = {
              ...
              vAxis: {title: 'Calificación Semanal' ,format:'#%', minValue:0.0, maxValue:1.0, titleTextStyle : {fontSize: 16, bold:true}},
    ...
    var pareto_CNC=function(nombre){
        ...
        var jsonData = $.ajax({
          ...
          function drawVisualization() {
            ...
            var options = {
              /*title :"",*/
              vAxes: {0:{title: 'Frecuencia' ,format:'#%', minValue:0.0, maxValue:1.0, titleTextStyle : {fontSize: 16, bold:true}}, 1:{title: 'Frecuencia Acumulada' ,format:'#%', minValue:0.0, maxValue:1.0, titleTextStyle : {fontSize: 16, bold:true}}},
        ...
        var jsonData = $.ajax({
          ...
          function drawVisualization() {
            ...
            var options = {
              ...
              vAxis: {title: 'Causas de No Cumplimiento' ,format:'#', titleTextStyle : {fontSize: 16, bold:true}},
    ...
    var ind_compromisos_semana=function(nombre){
        ...
        var names = ['Tareas Críticas Comprometidas', 'Tareas No Críticas Comprometidas', 'Tareas Atrasadas Comprometidas', 'Tareas Comprometidas Sin Liberar Restricciones'];
        ...
        var makeBarWithBar = function (gauge, radius, i, width, without_stroke) {
            ...
            if (without_stroke) {
                stroke = null;
                gauge.label(i)
                        .text('<span style="color: black; font-size: 11.5px;" >' + names[i] + ", " + label + '</span>')// color: #7c868e
                        .useHtml(true);
                gauge.label(i)
                        .hAlign('center')
                        .vAlign('middle')
            ...
            }else if(data[2][3]<=30 && data[2][3]>5){
            ...
            gauge.bar(i).dataIndex(i)
                    ...
                    .stroke(null)
                    .zIndex(4);
            gauge.bar(3).dataIndex(3)
                    .radius(radius)
                    .width(width*1.03)
                    .fill(color_d)
                    .stroke(null)
                    .zIndex(4);
            gauge.bar(i + 100).dataIndex(4)
                    .radius(radius)
                    .width(width)
        ...
        anychart.onDocumentReady(function () {
            ...
            var axis = gauge.axis().radius(130).width(1).fill(null);
            axis.scale()
                    .minimum(0)
                    .maximum(100)
                    .ticks({interval: 5})
    ...
    var ind_compromisos_acumulado=function(nombre){
        ...
        var makeBarWithBar = function (gauge, radius, i, width, without_stroke) {
            ...
            if(data[3][3]>30){
                color_d="rgb(231, 76, 60)";
            }else if(data[3][3]<=30 && data[3][3]>5){
                color_d="rgb(241, 196, 15)";
            }else if(data[3][3]<=5){
                color_d="rgb(29, 131, 72)";
            }
        ...
        anychart.onDocumentReady(function () {
            ...
            gauge.margin(50);
            gauge.title().text('<span style="color:black; font-size: 16px; font-weight: bold">Indicadores Actividades Comprometidas</span>' +
                    '<br/><span style="color:black; font-size: 14px;">(Acumulado)</span><br/><br/>').useHtml(true);
            gauge.title()
                    .enabled(true)
                    .hAlign('center')
                    .padding(0)
        ...
        google.charts.setOnLoadCallback(drawVisualization);	
          ...
          function drawVisualization() {
            ...
            var options = {
              ...
              titlePosition: 'right',
              vAxis: {title: '(%)' ,format:'#%', titleTextStyle : {fontSize: 16, bold:true}},
              hAxis: {title: 'Semanas', titleTextStyle : {fontSize: 16, bold:true}},
              seriesType: 'bars',
            ...
            chart.draw(data, options);
              ...
              function selectHandler() {
                ...
                }else if(tipo_compromiso=="% Actividades Atrasadas Comprometidas"){
                    tipo_compromiso1 ="atrasadas"
                ...
                var clase_PAC = $('#clase_PAC').val();
                  ...
                  if(trigger==1 || trigger=='100%' || trigger=='NA' || (tipo_columna==7 && trigger==0) || (tipo_columna==8 && trigger=='0%')){
        ...
        var jsonData = $.ajax({
          ...
          function drawVisualization() {
            ...
            var options = {
              ...
              legend:{position: 'bottom', textStyle: {fontSize: 14}},
              title :"Calificación Integral de Terceros",
              titleTextStyle: {fontSize: 16,},
              titlePosition: 'right',
              vAxes: {0:{title: 'Calificación Integral' ,format:'#%', minValue:0.0, maxValue:1.0, titleTextStyle : {fontSize: 16, bold:true}}, 1:{title: 'Frecuencia Acumulada' ,format:'#%', minValue:0.0, maxValue:1.0, titleTextStyle : {fontSize: 16, bold:true}}},
              hAxis: {title: 'Terceros', titleTextStyle : {fontSize: 16, bold:true}},
              seriesType: 'bars',
              series: {0: {color: "rgb(55,86,54)"}, 1: {color: "rgb(191,215,48)"}, 2: {color: "rgb(118,68,138)"}, 3: {color: "rgb(245,176,65)"}},
              // isStacked: true 
            ...
            chart.draw(data, options);
              ...
              function selectHandler() {
                ...
                if(tipo_calificacion=="Calificación Integral Acumulada"){
                ...
                if(calificacion=="NA"){
                    ...
                    if(tipo_calificacion1=="integral_acumulada"){
                        $('#modal_calificacion_contratistas_Label').text("Detalle Calificación Integral Acumulada, Tercero: " + subcontratista);
                        ...
                        $('#modal_calificacion_contratistas_Label').text("Detalle Calificación Integral Última Semana, Tercero: " + subcontratista);
                        $("#modal_calificacion_contratistas").fadeIn(1000).modal();
                        listar_detalle_cal_contratistas(tipo_calificacion1, subcontratista, semana);
                    }    
                }
        ...
        var jsonData = $.ajax({
          ...
          function drawVisualization() {
            ...
            var options = {
              ...
              titlePosition: 'right',
              vAxes: {0:{title: 'Calificación Integral' ,format:'#%', minValue:0.0, maxValue:1.0, titleTextStyle : {fontSize: 16, bold:true}}, 1:{title: 'Frecuencia Acumulada' ,format:'#%', minValue:0.0, maxValue:1.0, titleTextStyle : {fontSize: 16, bold:true}}},
              hAxis: {title: 'Profesionales', titleTextStyle : {fontSize: 16, bold:true}},
              seriesType: 'bars',
            ...
            chart.draw(data, options);
              ...
              function selectHandler() {
                ...
                if(calificacion=="NA"){
                    ...
                    if(tipo_calificacion1=="integral_acumulada"){
                        $('#modal_calificacion_profesionales_Label').text("Detalle Calificación Integral Acumulada, Profesional: " + profesional);
...
//                "responsive":true,
                ...
                "columns":[
                    ...
                    {"data":"Responsable_AIA"},
                    {"data":"Categoria_CNP", "visible": false},
                    {"data":"CNP"},
