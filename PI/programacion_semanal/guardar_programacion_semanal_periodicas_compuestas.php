...
function agregar_actividad($Id, $semana, $Actividad, $Descripcion, $Clase, $Sub_Contratista, $Responsable_AIA, $Unidad, $Compromiso, $db, $conexion){
    ...
    $query1="INSERT INTO $db"."_programacion_semanal (Consecutivo, Semana, Consecutivo_En_Programa, Id, Actividad, Descripcion, Clase, Sub_Contratista, Responsable_AIA, Unidad, Compromiso, Critica, Atrasada, Activa, Prog_Sin_Restricciones_100) VALUES (NULL, $semana, $consecutivo_en_programa, '$Id', '$Actividad', '$Descripcion', 'periodicas_compuestas', '$Sub_Contratista', '$Responsable_AIA', '$Unidad', $Compromiso, 0, 0, 'NA', 0);";
...
function duplicar($Id, $semana, $Actividad, $db, $conexion){
    $query="INSERT INTO $db"."_programacion_semanal (Semana, Consecutivo_En_Programa, Id, Actividad, Clase, Critica, Atrasada, Activa, Prog_Sin_Restricciones_100) SELECT 
        ...
        'periodicas_compuestas (duplicada)',
        0, 
        0,
        'NA',
