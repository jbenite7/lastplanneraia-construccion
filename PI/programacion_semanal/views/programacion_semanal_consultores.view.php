            ...
            <nav class="navbar navbar-expand-m navbar-dark ">
              <a class="navbar-brand" href="#">
                <ul>
                    ...
                    <li class="lps">LPS</li>
                    <li class="pagina"> - Programacion Semanal / Consultores / Semana <?php echo $semana ?></li>
                </ul>
              </a>
				...
				<div class="form-group">
					<div class="col-sm-offset-1 ">
                        ...
                        <div class="grupo_botones btn-group" role="group" aria-label="Basic example" style="padding:10">
                            ...
                            <button id="btn_Actividades" type="button" class="btn btn-success btn-sm active" onclick="window.location.href='<?php echo "../cambiar_pagina.php?seccion=programacion_semanal_consultores&semana=$semana"?>'">Consultores <i class="fas fa-arrow-right fa-m"></i></button>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
                            ...
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close" onClick="location.assign('posicion_semanal_consultores.php?posicion_semanal='+ $('.dataTables_scrollBody').scrollTop());"><span aria-hidden="true">&times;</span></button>
						</div>
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-default" data-dismiss="modal" onClick="location.assign('posicion_semanal_consultores.php?posicion_semanal='+ $('.dataTables_scrollBody').scrollTop());">Cancelar</button>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-danger" data-dismiss="modal" onClick="location.assign('posicion_semanal_consultores.php?posicion_semanal='+ $('.dataTables_scrollBody').scrollTop());">No</button>
						</div>
					</div>
				</div>
			</div>-->
...
<!--    <script type='text/javascript'>document.oncontextmenu = function(){return false}</script>-->
	...
	<script>
		...
		var guardar_formulario = function(){
			$("form").on("submit", function(e){
				...
				$.ajax({
					method: "POST",
					url: "../programacion_semanal/guardar_programacion_semanal_consultores.php?db=<?php echo $db?>",
			...
			$("#btn_guardar1").on("click", function(e){
                ...
                if((Ejecutado_Real1 - Compromiso1)<0 && Ejecutado_Real1 !='' && Compromiso1 !=''){
                    ...
                    $.ajax({
                        ...
                        location.assign("posicion_semanal_consultores.php?posicion_semanal="+posicion);
                    });    
                }
			});
		}
    ...
    //                "responsive":true,
                    ...
                    "ajax":{
                      "method":"POST",
                      "url":"../programacion_semanal/listar_programacion_semanal_consultores.php<?php echo "?db=$db&semana=$semana"?>"
                  },
