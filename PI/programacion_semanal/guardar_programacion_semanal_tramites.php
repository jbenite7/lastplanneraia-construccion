...
$opcion=/*"autoprogramar"*/$_POST["opcion"];
$informacion=[];
...
if ($opcion == "modificar") {
    ...
    $f_inicio_sem=date("Y-m-d",strtotime(/*"2020-07-21"*/$_POST["f_inicio_sem"]));
...
function agregar_actividad($Id, $semana, $Actividad, $Descripcion, $Clase, $Sub_Contratista, $Responsable_AIA, $Unidad, $Compromiso, $db, $conexion){
    ...
    $query1="INSERT INTO $db"."_programacion_semanal (Consecutivo, Semana, Consecutivo_En_Programa, Id, Actividad, Descripcion, Clase, Sub_Contratista, Responsable_AIA, Unidad, Compromiso, Critica, Atrasada, Activa, Prog_Sin_Restricciones_100) VALUES (NULL, $semana, $consecutivo_en_programa, '$Id', '$Actividad', '$Descripcion', 'tramites', '$Sub_Contratista', '$Responsable_AIA', '$Unidad', $Compromiso, 0, 0, 'NA', 0);";
