<?php
    ...
    require("../conexion.php");
    $query4="SELECT  COUNT(*) FROM $db"."_programacion_semanal WHERE Semana='$semana' AND (Activa='1' OR Activa='NA')  AND (Clase='consultores' OR Clase='Checklist Consultores' OR Clase='consultores (duplicada)')";
    ...
    if ($conteo==0){
        ...
        require ("../conexion.php");
        $query5 = "SELECT * FROM $db"."_programacion_semanal WHERE Semana='$semana' AND (Activa='1' OR Activa='NA')  AND (Clase='consultores' OR Clase='Checklist Consultores' OR Clase='consultores (duplicada)') ORDER BY Consecutivo_En_Programa ASC";
