...
if ($opcion == "checklist") {
    ...
    $f_inicio_sem=date("Y-m-d",strtotime(/*"2020-07-14"*/$_POST["f_inicio_sem"]));
...
function comprometer_requerimiento($consecutivo, $semana, $checklist, $requerimiento, $consecutivo_requerimiento, $db, $conexion){
    ...
    if($conteo>0){ 
        ...
        $query2="INSERT INTO $db"."_programacion_semanal (Consecutivo, Semana, Consecutivo_en_Programa, Id, Actividad, Descripcion, Clase, Critica, Atrasada, Activa, Prog_Sin_Restricciones_100) VALUES (NULL, $semana, $consecutivo, '$Id (R$consecutivo_requerimiento)', '$requerimiento', 'Requerimiento de la actividad: $Actividad', 'Checklist Tramites', $Ruta_Critica, $Atrasada, 'NA', 0)";
        $resultado2= mysqli_query($conexion, $query2);
    }
    cerrar($conexion);
}
