...
switch($opcion){
    case 'modificar':
        modificar($Relevancia, $Ejecutado, $Observaciones, $Id, $semana, fecha_inicio_sem($semana, $db, $conexion), $db, $conexion);
        break;
...
function modificar($Relevancia, $Ejecutado, $Observaciones, $Id, $semana, $inicio_semana, $db, $conexion){
    //$query = "UPDATE $db"."_programa_consolidado SET Activa=1 WHERE Consecutivo_en_Programa='$Id' AND Semana=$semana;";
    $query1 = "UPDATE $db"."_programa_consolidado SET Relevancia='$Relevancia', Ejecutado='$Ejecutado', Observaciones='$Observaciones' WHERE Consecutivo_en_Programa='$Id' AND Semana=$semana";
    //echo $query1;
