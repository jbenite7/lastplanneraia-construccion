...
(function () {
  ...
  loadScript('/construccion/js/tablet-viewport-scale.js?v=1.2');
  loadScript('/construccion/js/datatable-height-manager.js?v=1.1');
  loadScript('/construccion/js/mobile-table-fix.js?v=mobileFix2');
  loadScript('/construccion/js/global-table-align.js?v=1.0');
  
  // Script de Capacidades RBAC Moderno
  loadScript('/construccion/js/rbac_capabilities.js?v=1.0');
})();
