      ...
      if(faltaCalificar != 0){
        ...
        $.ajax({
          ...
          if(semanalConfirmada == 0 && permiso != 'P'){
            window.alert("No se pueden crear la Semana " + (Number(semana)+1) + " hasta que se confirmen los compromisos en la Semana " + semana);
            location.assign("../cambiar_pagina.php?seccion=programacion_semanal&semana="+semana);
          }else{
            if(pdcConteo == 0){
              if(carpeta == 1){
