...
- [x] **Fix Falsos Duplicados en Subcontratistas (2026-04-08)**: La fila borrador de Handsontable ya no se compara consigo misma al crear un subcontratista, evitando bloqueos falsos por nombre, correo y NIT.
