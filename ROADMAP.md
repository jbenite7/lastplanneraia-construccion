...
- [x] **Corrección Integral del Motor de Ejecución (Base Ratio 0-1) ✅ (2026-03-16)**
    ...
    - [x] **Estandarización Final AIA.Notice**: Migración total de `Swal.fire` y `window.confirm` a la capa oficial. Se refactorizó el interceptor para soporte de Promesas booleanas y firmas duales, eliminando 26 instancias redundantes en Subcontratistas, Profesionales, Programación Semanal y Administración. ✅ (2026-03-18)
     ...
     - [x] **Contexto Inteligente de Aterrizaje por Proyecto (2026-03-25)**: Nuevo `ProjectLandingService` para resolver semana/modulo de entrada segun semanas activas, pendientes de calificacion y rol; `Dashboard`, selector de proyecto, Programa General y Programacion Semanal ahora sanean contexto antes de navegar o renderizar.
...
- [x] **Eliminación Condicional de Permisos por Proyecto (2026-03-27)**: Implementación de validación AJAX en la vista de edición de usuarios. Bloqueo de eliminación en proyectos activos con actividades programadas (`Responsable_AIA`) y automatización de bloqueo de profesional al retirar permisos. ✅
