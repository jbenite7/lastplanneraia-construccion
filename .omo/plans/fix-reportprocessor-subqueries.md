# fix-reportprocessor-subqueries - Work Plan
...
- Evidence: .omo/evidence/task-<N>-fix-reportprocessor-subqueries.<ext>
...
- [ ] 1. <title>
  ...
  QA scenarios (name the exact tool + invocation): happy + failure, Evidence .omo/evidence/task-1-fix-reportprocessor-subqueries.<ext>
