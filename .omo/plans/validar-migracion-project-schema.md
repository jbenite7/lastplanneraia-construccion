# validar-migracion-project-schema - Work Plan
...
- Evidence: .omo/evidence/task-<N>-validar-migracion-project-schema.<ext>
...
- [ ] 1. <title>
  ...
  QA scenarios (name the exact tool + invocation): happy + failure, Evidence .omo/evidence/task-1-validar-migracion-project-schema.<ext>
