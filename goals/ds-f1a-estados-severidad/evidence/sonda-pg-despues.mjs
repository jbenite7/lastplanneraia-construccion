...
const FILAS = [
  ...
  {
    unique_id: 207, Id: 207, Titulo: 0, Actividad: 'Vigas de amarre eje 5', Estado: 'Actividad Futura', Ejecutado: 0, unidad: 'ml',
    Semanas_Inicio: 1, Ruta_Critica: '0', alerta_crisis: 0,
    D_y_E: '0%', Materiales: '0%', MdeO: '0%', Equipos: '0%', Predecesora: '0%',
  },
];
...
writeFileSync(`${OUT}medicion-pg-computada.json`, JSON.stringify(salida, null, 2));
await page.screenshot({ path: `${OUT}pg-siete-estados-1180x820-dark.png` });
