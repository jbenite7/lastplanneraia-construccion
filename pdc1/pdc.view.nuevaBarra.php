				...
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="modalContratoLabel">
							<p class="modal-body-texto-Contrato" id="modal-body-texto-Contrato"></p>
						</h5>
									...
									<div class="form-group">
										<div class="form-group parametro_Contrato">
											...
											<div class="col-sm-12" style="display:flex; align-items:center; border-bottom-color:black">
												...
												<div id='divActividadesDelContrato' name='divActividadesDelContrato' style='width:1200px; max-width:60% ; padding:1px; margin:0 auto; display:inline-block; text-align:center'><textarea id="actividadesDelContrato" name="actividadesDelContrato" class="form-control" style='background:white' readonly></textarea>
												</div>
											</div>
											<br>
											<div class="col-sm-12" style="display:flex; align-items:center; border-bottom-color:black">
												...
												<div id='divFechaActual' name='divFechaActual' style='width:1200px; max-width:29% ; padding:1px; margin:0 auto; display:inline-block; text-align:center'><input id='fechaActual' name='fechaActual' class='form-control' type='text' value='' placeholder='Fecha de Corte' style='background:white; text-align:center' autocomplete="off" readonly>
												</div>
										...
										<div class="form-group parametro_Contrato" id="seccionSeguimientoContrato">
											...
											<div class="container informacionAdjudicacionContrato">
												...
												<div class="row">
													<div class="form-group col">
														<label for="valorPresupuesto" class"labelFormularioAdjudicado">Valor en Presupuesto</label>
														<input type="text" class="form-control" id="valorPresupuesto" name="valorPresupuesto" value="" data-type="currency" placeholder="Valor en Pesos Colombianos">
													</div>
													<div class="form-group col">
      ...
      listar();
		...
		var listar = function() {
		  ...
		  var table = $("#dt_cliente").DataTable({
		    ...
		    "ajax": {
		      "method": "POST",
		      "url": "../pdc/listar_pdc.php?db="+db+"&semana="+Max_Semana
		    },
            ...
            { orderable: false, targets: '_all' },
				...
				"createdRow": function( row, data, dataIndex){
						...
						}else if(data.fechaInicioProyectada == ""){
		  ...
		  $(tbody).one("click", "td", function() {
				if (only_once == true) {
					...
					if(data.titulo==0){
						...
						$("#modal-body-texto-Contrato").html("Estado del Proceso de Contratación: <b>" + data.paqueteContratacion + "</b>");
		...
		var guardar_modificar = function() {
			$("#btn_guardar_pdc").one("click", function(e){
				...
				frm = frm + "&db=" + db + "&Id=" + Id + "&opcion=" + opcion + "&tipoPaquete=" + tipoPaquete + "&semana=" + semana;
        		console.log(frm);
				$.ajax({
					method: "POST",
					url: "../pdc/guardar_pdc.php",
