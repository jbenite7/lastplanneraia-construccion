 ...
 * su adaptador PHP, y que restaurar el mapa hace que React vuelva a servirla. Usa `/lookahead`
 * como "pantalla migrada de muestra" hipotética (S07, pendiente de migración): hoy NO está en
 * `RUTAS_EXACTAS_MIGRADAS`, así que este test simula el escenario general de rollback sin
 * depender de que exista una siguiente pantalla ya migrada.
 *
