...
- **Rutas, sesión o RBAC:** contrasta `public/index.php`, catálogos y middleware según el área modificada. Verifica al menos un rol permitido y uno denegado cuando cambien rutas protegidas, sesión, middleware, capacidades o RBAC.
